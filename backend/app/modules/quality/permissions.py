...
PERMISSIONS: list[PermissionDef] = [
    ...
    # ── 标准库/模板维护 ──
    PermissionDef("quality:standard:manage", "维护产品标准（文档/项目行/导入）", "quality", "standard", "manage"),
    PermissionDef("quality:template:manage", "维护报告模板（上传/删除/绑定）", "quality", "template", "manage"),
    # ── 偏差管理 ──
