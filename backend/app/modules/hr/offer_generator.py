...
def _generate_offer_pdf_fallback(**kwargs) -> BytesIO:
    ...
    pdf.set_font(fn, "", 10)
    items = [
        f"恭喜您从众多应聘者中脱颖而出，成为丽珠大家庭的一员。根据您的经验、技能、学历和各方综合素质，并与您本人协商后，我公司对您的入职相关事宜做以下安排：",
        ...
        f"4、试用期：根据《劳动合同法》的相关规定，您的试用期为叁个月（根据工作表现和工作业绩可适当缩短试用期）。首次期间签订叁年的劳动合同及签订关键岗位保密协议。",
