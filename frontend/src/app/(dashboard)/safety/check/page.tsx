...
import { useSafetyCheckStore } from '@/stores/safety'
import {
  getChecks,
  createCheck,
  updateCheck,
...
export default function SafetyCheckPage() {
  ...
  const {
    ...
    setItems: setChecks,
    setTotal: setCheckTotal,
    setQueryParams: setCheckQueryParams,
    addItem: addCheck,
    updateItem: updateCheckInStore,
    removeItem: removeCheck,
  } = useSafetyCheckStore()
