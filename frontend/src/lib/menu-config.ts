...
export const moduleMenus: ModuleMenu[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "probation", label: "试用期管理", path: "/hr/probation" },
      {
        key: "training",
        label: "培训管理",
        path: "/hr/training",
        children: [
          ...
          { key: "question-bank", label: "共享题库", path: "/hr/training/question-bank" },
        ],
      },
      { key: "notifications", label: "通知记录", path: "/hr/notifications" },
      { key: "printing", label: "资料打印", path: "/hr/printing" },
      {
        key: "settings",
        label: "系统设置",
        path: "/hr/settings",
        ...
        children: [
          { key: "system-config", label: "发件邮箱", path: "/hr/settings" },
          { key: "positions", label: "岗位管理", path: "/hr/positions" },
          { key: "trainers", label: "内训师台账", path: "/hr/training/trainers" },
          { key: "sop-catalog", label: "SOP目录", path: "/hr/training/sop-catalog" },
        ],
      },
    ],
  },
