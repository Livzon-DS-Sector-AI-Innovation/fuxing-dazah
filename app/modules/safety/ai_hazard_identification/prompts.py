...
**冲突处理**：安全优先、从严判定。若同时满足多个级别条件，按最高级别处理。
...
FEWSHOT_EXAMPLES = [
    {
        ...
        "output": {
            ...
            "hazard_level": "major",
            "rectification_suggestion": {
                "corrective": "立即停止该防爆电箱的供电，断开上级电源开关，在电箱周围设置临时警示标识防止人员误操作；由持证电工对该电箱未封堵的引入口加装符合GB 3836.1-2010标准的防爆堵头，使用防爆吸尘器清理箱内积尘（严禁使用压缩空气吹扫）；24小时内由电气工程师对责任区域内所有防爆电箱进行逐台排查，重点检查引入口封堵完好性、箱体腐蚀情况及接地连续性，建立排查清单并由车间主任签字确认，3个工作日内完成全部整改",
